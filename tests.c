...
static void array_stack(void **state)
{
...
static void array_stack_overflow(void **state)
{
	struct array_stack *stack = array_stack_init(3);
...
static void array_stack_underflow(void **state)
{
...
static void array_stack_uninitialized(void **state)
{
